...
public class SomeUsefulArrayMethods {
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("[6] Display values greater or equal than average");
            System.out.println("[7] Display values");
...
// checks if a given item is contained within the array
    ...
    static double average(int[] arrayIn){
        ...
        double avg = total/(double)arrayIn.length;
        return avg;
    }

    static void greaterThanAverage(int[] arrayIn){
        double avg = average(arrayIn);
        System.out.println(" The average value of the entries in the array is " + avg);
        System.out.println();
        System.out.println(" The entries greater than or equal to the average are as follows:");
        for (int i = 0; i < arrayIn.length; ++i){
            if(arrayIn[i] >= avg){
                System.out.println(" array[" + i +"] = " + arrayIn[i]);
            }
